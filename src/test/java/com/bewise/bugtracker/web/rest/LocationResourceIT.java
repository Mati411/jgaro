...
import com.bewise.bugtracker.domain.Location;
import com.bewise.bugtracker.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().streetAddress(DEFAULT_STREET_ADDRESS).city(DEFAULT_CITY).stateProvince(DEFAULT_STATE_PROVINCE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY).stateProvince(UPDATED_STATE_PROVINCE);
        return location;
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY).stateProvince(UPDATED_STATE_PROVINCE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.streetAddress(UPDATED_STREET_ADDRESS).stateProvince(UPDATED_STATE_PROVINCE);
