  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bugTrackerJHipsterApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="bugTrackerJHipsterApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.firstName')}
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="managerId"
                data-cy="manager"
                label={translate('bugTrackerJHipsterApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('bugTrackerJHipsterApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
