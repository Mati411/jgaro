...
export const RegionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bugTrackerJHipsterApp.region.delete.question">
        <Translate contentKey="bugTrackerJHipsterApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
