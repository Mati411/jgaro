...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bugTrackerJHipsterApp.country.delete.question">
        <Translate contentKey="bugTrackerJHipsterApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
