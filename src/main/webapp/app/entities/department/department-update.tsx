  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bugTrackerJHipsterApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="bugTrackerJHipsterApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('bugTrackerJHipsterApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="locationId"
                data-cy="location"
                label={translate('bugTrackerJHipsterApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
