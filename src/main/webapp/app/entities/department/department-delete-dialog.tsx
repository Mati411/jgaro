...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bugTrackerJHipsterApp.department.delete.question">
        <Translate contentKey="bugTrackerJHipsterApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
